...
class PlateDataset(Dataset):
    ...
    def _prepare_data(self) -> List[Dict]:
        ...
        """
        self.data = []
        self.class_distribution = {}  # Dictionary to store class name -> count mapping
        ...
        for img_info in annotations:
            ...
            for box_info in img_info["boxes"]:
                ...
                if box_info["id"] not in self.class_distribution:
                    self.class_distribution[box_info["id"]] = 0
                self.class_distribution[box_info["id"]] += 1
